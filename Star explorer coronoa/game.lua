...
local function gameLoop()
	...
	for i = #asteroidsTable, 1, -1 do
		...
		if( thisAsteroid.x < -100 or thisAsteroid.x > display.contentWidth + 100 or thisAsteroid.y < -100 or thisAsteroid.y > display.contentHeight + 100 )
		then
...
local function endGame()
	...
	composer.gotoScene( "highscores", { time = 800, effetcs = "crossFade" } )
end
